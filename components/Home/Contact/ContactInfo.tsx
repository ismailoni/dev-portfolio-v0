    ...
    <div>
        <div className='flex items-center space-x-8 mb-8'>
            ...
            <div className='text-white'>
                ...
                <h1 className='text-base sm:text-lg text-opacity-70'>{contactData.phone}</h1>
            </div>
        </div>
        <div className='flex items-center space-x-8 mb-8'>
            <div className='w-10 h-10 md:w-16 md:h-16 rounded-full bg-gradient-to-r from-emerald-500 to-emerald-900 flex items-center justify-center flex-col'>
            ...
            <div className='text-white'>
                <h1 className='text-lg sm:text-xl font-bold'>Email Address</h1>
                <h1 className='text-base sm:text-lg text-opacity-70'>{contactData.email}</h1>
            </div>
        </div>
        <div className='flex items-center space-x-8'>
            ...
            <div className='text-white'>
                <h1 className='text-lg sm:text-xl font-bold'>Address</h1>
                <h1 className='text-base sm:text-lg text-opacity-70'>{contactData.address}</h1>
            </div>
        </div>
    </div>
  )
